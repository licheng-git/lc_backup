...
@interface ActionSheetExt ()<UITableViewDataSource , UITableViewDelegate , UIGestureRecognizerDelegate>
...
-(void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    [self tappedCancel];
    if (_delegate != nil && [_delegate respondsToSelector:@selector(ActionSheetExtDidSelectIndex:)]) {
        [_delegate ActionSheetExtDidSelectIndex:indexPath.row];
    }
}
